...
return [
    ...
    */
    ...
    'password' => 'Пароль',
    'non_public_info' => 'Приватная информация, только для администрации',
    'history' => 'История анализов',
    'file_formats' => 'Вы можете добавить файлы форматов: PDF и файлы Office',
    'file_name' => 'Имя файла',
    'add_button' => 'Добавить',
    'search_caption' => 'Поиск по истории анализов',
