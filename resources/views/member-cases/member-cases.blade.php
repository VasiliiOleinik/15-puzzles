                ...
                <div class="breadcrumbs">
                    <ul class="breadcrumbs__list">
                        ...
                        <li class="breadcrumbs__element"><a class="breadcrumbs__link current"
                                                            href="javascript:void(0);">@lang('breadcrumbs.member_cases')</a>
                        </li>
                    </ul>
                </div>
                <div class="main-content">
                    ...
                    <div class="post_container">
                        @foreach($memberCases as $memberCase)
                            <div class="post">
                                <a class="post__image"
                                   href="{{ url(app()->getLocale().'/member_cases') }}/{{ $memberCase->alias }}">
                                ...
                                <a class="post__date"
                                   href="javascript:void(0)">{{$memberCase->updated_at->format('d.m.Y')}}</a>
                                <a class="post__title"
                                   href="{{ url(app()->getLocale().'/member_cases') }}/{{ $memberCase->alias }}">{!!$memberCase->title!!}
            ...
            <div class="cases-right">
                <div class="subscribe">
                    ...
                    <form id="member-cases-subscribe-form" class="subscribe__input" method="get">
                        <div class="label">
                            @auth
                                ...
                                <label for="email-subscribe"
                                       class="dinamic-label-js">@lang('member_cases.placeholder_subscribe')</label>
                            @endauth
                            @guest
                                <input class="subscribe-field dinamic-input-js" type="text" name="email-subscribe">
                                <label for="email-subscribe"
                        ...
                        <button class="subscribe-btn" type="submit" id="send-form-btn"><img src="/img/svg/envelope.svg"
                ...
                @auth
                    <div class="add-story">
                        ...
                        <form class="add-story__form" method="post"
                              action="{{ route('create_post', app()->getLocale()) }}" enctype="multipart/form-data">
                            @csrf

                            <input id="img" type="hidden" name="img">
                            <div class="label">
                                <input class="headline inp dinamic-input-js" type="text" name="headline" required>
                                <label for="headline" class="dinamic-label-js">@lang('member_cases.headline') <span
                                        class="required">*</span></label>
                            </div>
                            <div class="label">
                                <textarea class="story inp dinamic-input-js" name="your-story" required></textarea>
                                <label class="textarea dinamic-label-js"
                                       for="your-story">@lang('member_cases.your_story') <span class="required">*</span></label>
                            </div>
                                ...
                                <div class="images-container">
                                    <div class="item-img">
                                        ...
                                        <button class="file-upload">
                                            <input name="image-file" class="file-input" type="file"
                            ...
                            <div class="member-case-tags__cloud">
                                ...
                                <select class="js-example-basic-multiple" name="states[]" multiple="multiple"
                                    ...
                                    @foreach($member_cases_tags as $member_cases_tag)
                                        <option
                                            value='{{ $member_cases_tag->tag_id }}'>{{ $member_cases_tag->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="footer-form">
                                <label>
                                    <input class="checkbox" name="anonym" type="checkbox"><span
                                        class="checkbox-custom"></span><span
                                        class="label">@lang('member_cases.do_not_publish')</span>
                                </label>
                                <input class="submit-form" type="submit"
                                       value="@lang('member_cases.submit_for_moderation')">
                            </div>
                        </form>
                    </div>
                @endauth
