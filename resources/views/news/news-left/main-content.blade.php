                ...
                <div class="post_container">
                  ...
                  <div class="post">
                    @php
                      //форматируем
                      $articleTitle = mb_strtolower($article->article->title);
                      $articleTitle = preg_replace('#[[:punct:]]#', '', $articleTitle);
                      $articleTitle = str_replace(' ', '-', $articleTitle);
                    @endphp
                    <a class="post__image" href="{{ url(app()->getLocale().'/news') }}/{{$articleTitle}}"
                    ...
                    <a class="post__title" href="{{ url(app()->getLocale().'/news') }}/{{ $articleTitle }}">
