              ...
              <div class="diagram__left">
                <div class="diagram__group">
                  ...
                  <div class="group_content">
                    <div class="group_item mutagenesis">
                      <p>DNA mutagenesis</p>
                    </div>
                    <div class="group_item infections">
                      <p>Infections / Viruses / helmints /inflammation spiritual & psychoemotional</p>
                    </div>
                    <div class="group_item oxygen">
                      <p>Lack of oxygen</p>
                    </div>
                  </div>
                </div>
                <div class="diagram__group">
                  ...
                  <div class="group_content">
                    <div class="group_item supply">
                      <p>Supply (type of glycolysis)</p>
                    </div>
                    <div class="group_item ph_status">
                      <p>PH status of cell surrounding</p>
                    </div>
                    <div class="group_item rversal">
                      <p>Reversal to aerobic breathing</p>
                    </div>
                    <div class="group_item lectronic">
