...
<body>
    @foreach($memberCases as $memberCase)
        ...
        <img class="news-image" src="{{ asset($memberCase->memberCase->img) }}" alt=""
                style="
                        display: flex;
                        max-width: 134px;
                        max-height: 134px;
        ...
        <div class="news-detail"
            ...
            "
            >
            <a class="news-name" href="{{ url($language.'/member_cases') }}/{{$memberCase->memberCase->alias}}"
                style="
                        color: #364458;
                        font-size: 18px;
                        font-weight: 600;
            ...
            <a class="news-date" href="{{ url($language.'/member_cases') }}/{{$memberCase->memberCase->alias}}"
                style="
                        color: #599ba7;
                        font-size: 14px;
                        font-weight: 400;
            ...
            <a class="news-text " href="{{ url($language.'/member_cases') }}/{{$memberCase->memberCase->alias}}"
                style="
                        color: #59596a;
                        font-size: 15px;
                        font-weight: 400;
